...
namespace MicropolisCore
{
    public partial class Micropolis
    {
        ...
        ///      doc/AnimationSequences.txt and the dos/genAnimationTable.py
        ///      program
        /// </summary>
        short[] animatedTiles = {
        ...
        public void animateTiles()
        {
            ...
            for (int x = 0; x < Micropolis.WORLD_W; x++)
            {
                ...
                {
                    tilevalue = map[x, y];
                    if ((ushort)(tilevalue & (ushort) MapTileBits.ANIMBIT) != 0)
                    {
                        tileflags = (ushort) (tilevalue & (ushort) MapTileBits.ALLBITS);
                        tilevalue &= (ushort) MapTileBits.LOMASK;
                        tilevalue = (ushort) animatedTiles[tilevalue];
                        tilevalue |= tileflags;
                        map[x, y] = tilevalue;
                    }
                }
